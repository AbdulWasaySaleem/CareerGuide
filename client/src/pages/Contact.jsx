        ...
        <div className="bg-gradient-to-r from-indigo-700 to-purple-700 rounded-2xl p-6 mb-8 text-white shadow-xl">
          <div className="text-center">
            ...
            <p className="opacity-90 text-sm md:text-base max-w-2xl mx-auto">
              Have questions about our career services or need assistance? We're
            ...
            <div className="bg-white rounded-xl shadow-md p-6 h-full">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:support@careermentor.com"
              ...
              <div className="mt-8 pt-6 border-t border-gray-100">
                ...
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="bg-gray-100 p-2 rounded-full hover:bg-indigo-100 transition"
                  >
                    <svg
              ...
              {formStatus === "success" ? (
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <button
                    ...
                    className={`w-full md:w-auto px-6 py-3 bg-indigo-600 text-white font-medium rounded-lg shadow-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ${
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="border border-gray-100 rounded-lg p-5 hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                Yes, we offer personalized career counseling sessions. You can
                book an appointment through our platform after taking the
                assessment.
              </p>
            </div>
            ...
            <div className="border border-gray-100 rounded-lg p-5 hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                Our basic career assessment and recommendations are free.
                Premium features and personalized counseling are available with
                subscription plans.
              </p>
            </div>
            ...
            <div className="border border-gray-100 rounded-lg p-5 hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                Our recommendations are based on scientific assessment models
                with over 90% accuracy, tested across various demographics and
